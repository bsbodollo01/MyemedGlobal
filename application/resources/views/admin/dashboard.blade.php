@extends('layouts.default')
    ...
    @section('meta')
        <title>Dashboard | Myemed Global</title>
        <meta name="description" content="Myemed Global dashboard, view recent attendance, recent leaves of absence, and newest employees">
    @endsection
