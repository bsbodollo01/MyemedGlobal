@extends('layouts.default')
    ...
    @section('meta')
        <title>Leave of Absence | Myemed Global</title>
        <meta name="description" content="Myemed Global leave of absence, view all employee leaves of absence, edit, comment, and approve or deny leave requests.">
    @endsection 
