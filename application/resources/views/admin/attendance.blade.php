@extends('layouts.default')
    ...
    @section('meta')
        <title>Attendance | Myemed Global</title>
        <meta name="description" content="Myemed Global attendance, view all employee attendances, clock-in, edit, and delete attendances.">
    @endsection
