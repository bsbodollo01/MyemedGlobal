@extends('layouts.default')
    ...
    @section('meta')
        <title>Accounts | Myemed Global</title>
        <meta name="description" content="Myemed Global departments, view departments, and export or download departments.">
    @endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title uppercase">{{ __("Accounts") }}
                ...
                <div class="box box-success">
                    <div class="box-body">
                        ...
                        <form id="add_department_form" action="{{ url('fields/department/add') }}" class="ui form" method="post" accept-charset="utf-8">
                            @csrf
                            <div class="field">
                                <label>{{ __("Account Name") }} <span class="help">e.g. "Calvary,Ahmad"</span></label>
