@extends('layouts.default')
    ...
    @section('meta')
        <title>Companies | Myemed Global</title>
        <meta name="description" content="Myemed Global companies, view companies, and export or download companies.">
    @endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title uppercase">{{ __("Company") }}
