@extends('layouts.default')
    ...
    @section('meta')
        <title>Leave Types | Myemed Global</title>
        <meta name="description" content="Myemed Global leave type, view leave types, add or edit leave types and export or download leave types.">
    @endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title uppercase">{{ __("Leave Types") }}
