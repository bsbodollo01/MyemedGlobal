@extends('layouts.default')
    ...
    @section('meta')
        <title>Leave Groups | Myemed Global</title>
        <meta name="description" content="Myemed Global leave groups, view leave groups, add leave groups, and edit leave groups.">
    @endsection
