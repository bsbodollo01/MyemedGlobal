@extends('layouts.default')
    ...
    @section('meta')
        <title>Reports | Myemed Global</title>
        <meta name="description" content="Myemed Global reports, view reports, and export or download reports">
    @endsection
    ...
    <div class="container-fluid">
        ...
        <div class="row columnview">
            ...
            <div class="colview col-md-6">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{ __("Accounts Population") }}</h3>
                    </div>
                    <div class="box-body">
                        <div class="canvas-wrapper">
