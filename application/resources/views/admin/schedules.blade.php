@extends('layouts.default')
    ...
    @section('meta')
        <title>Schedules | Myemed Global</title>
        <meta name="description" content="Myemed Global schedules, view all employee schedules, add schedule or shift, edit, and delete schedules">
    @endsection
