@extends('layouts.default')
    ...
    @section('meta')
        <title>Employee Roles | Myemed Global</title>
        <meta name="description" content="Myemed Global roles, view all employee roles, add roles, edit roles, and delete roles.">
    @endsection
