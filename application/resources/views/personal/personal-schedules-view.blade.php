@extends('layouts.personal')
    ...
    @section('meta')
        <title>My Schedules | Myemed Global</title>
        <meta name="description" content="Myemed Global my schedules, view my schedule records, view present and previous schedules.">
    @endsection
