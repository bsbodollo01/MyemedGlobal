@extends('layouts.personal')
    ...
    @section('meta')
        <title>My Leave | Myemed Global</title>
        <meta name="description" content="Myemed Global my leave of absence, view my leave of absence records, edit pending leave request, and request leave of absence">
    @endsection
