@extends('layouts.personal')
    ...
    @section('meta')
        <title>My Dashboard | Myemed Global</title>
        <meta name="description" content="Myemed Global my dashboard, view recent attendance, view recent leave of absence, and view previous schedules">
    @endsection
