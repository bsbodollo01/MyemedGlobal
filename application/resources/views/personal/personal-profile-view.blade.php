@extends('layouts.personal')
    ...
    @section('meta')
        <title>My Profile | Myemed Global</title>
        <meta name="description" content="Myemed Global my profile, view my profile, and update my personal information">
    @endsection
